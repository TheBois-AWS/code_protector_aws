...
const routes = [
  ...
  { method: 'GET', path: '/api/admin/aws/cloudfront/invalidations', handler: (req) => adminController.listAdminAwsCloudFrontInvalidations(req) },
  { method: 'POST', path: '/api/admin/aws/cloudfront/invalidation', handler: (req) => adminController.createAdminAwsCloudFrontInvalidation(req) },
  { method: 'GET', path: '/api/admin/aws/cloudfront/invalidations/:id', handler: (req, params) => adminController.getAdminAwsCloudFrontInvalidation(req, params.id) },
  { method: 'GET', path: '/api/admin/aws/lambda/config', handler: (req) => adminController.getAdminAwsLambdaConfig(req) },
  { method: 'PATCH', path: '/api/admin/aws/lambda/concurrency', handler: (req) => adminController.patchAdminAwsLambdaConcurrency(req) },
  { method: 'PATCH', path: '/api/admin/aws/logs/retention', handler: (req) => adminController.patchAdminAwsLogsRetention(req) },
  { method: 'POST', path: '/api/admin/aws/alarms/:name/actions', handler: (req, params) => adminController.postAdminAwsCloudWatchAlarmActions(req, params.name) },
  { method: 'POST', path: '/api/admin/aws/alarms/:name/snooze', handler: (req, params) => adminController.postAdminAwsCloudWatchAlarmSnooze(req, params.name) },
  { method: 'DELETE', path: '/api/admin/aws/alarms/:name/snooze', handler: (req, params) => adminController.deleteAdminAwsCloudWatchAlarmSnooze(req, params.name) },
  { method: 'POST', path: '/api/admin/aws/s3/:bucket/rescan', handler: (req, params) => adminController.postAdminAwsS3Rescan(req, params.bucket) },
  { method: 'POST', path: '/api/admin/aws/s3/:bucket/versioning/enable', handler: (req, params) => adminController.enableAdminAwsS3Versioning(req, params.bucket) },
  { method: 'POST', path: '/api/admin/aws/s3/:bucket/encryption/enable', handler: (req, params) => adminController.enableAdminAwsS3Encryption(req, params.bucket) },
  { method: 'POST', path: '/api/admin/aws/dynamodb/:table/refresh', handler: (req, params) => adminController.refreshAdminAwsDynamoTable(req, params.table) },
  { method: 'PATCH', path: '/api/admin/aws/dynamodb/:table/deletion-protection', handler: (req, params) => adminController.patchAdminAwsDynamoTableDeletionProtection(req, params.table) },
